...
class Uji_Countdown_Admin {
   ...
   public function admin_timerset() {
      ...
      $cnt .= $this->cform_checkbox( __( "Show Responsive:", $this->plugin_slug ), array( 'ujic_resp' ), array( __("For Tablet and Mobile devices.", $this->plugin_slug ) ), array( ( isset($vars['ujic_resp']) ? $vars['ujic_resp'] : false ) ) );
